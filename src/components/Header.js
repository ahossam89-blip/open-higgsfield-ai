export function Header(navigate) {
    ...
    const items = ['Explore', 'Image', 'Video', 'Promo Video', 'Edit', 'Character', 'Contests', 'Vibe Motion', 'Cinema Studio', 'AI Influencer', 'Apps', 'Assist', 'Community'];
    ...
    items.forEach(item => {
        ...
        link.onclick = () => {
            ...
            else if (item === 'Promo Video') navigate('promo');
